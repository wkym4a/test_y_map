...
class MapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post maps_url, params: { map: { address: @map.address, latitude: @map.latitude, longitude: @map.longitude, name: @map.name } }
    end
  ...
  test "should update map" do
    patch map_url(@map), params: { map: { address: @map.address, latitude: @map.latitude, longitude: @map.longitude, name: @map.name } }
